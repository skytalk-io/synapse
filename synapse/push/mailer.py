...
class Mailer:
    ...
    async def send_login_3pid_mail(
        self, email_address: str, token: str, client_secret: str, sid: str
    ) -> None:
        """Send an email with a login 3pid confirmation link to a user

        Args:
            email_address: Email address we're sending the login 3pid
                token to
            token: Unique token generated by the server to verify
                the email was received
            client_secret: Unique token generated by the client to
            ...
            sid: The generated session ID
        """
        link = "Your email token is %s" % token
