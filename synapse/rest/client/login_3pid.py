...
class EmailLogin3pidRequestTokenRestServlet(RestServlet):
    ...
    async def on_POST(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        ...
        sid = await self.identity_handler.send_threepid_validation(
            ...
            client_secret,
            send_attempt,
            self.mailer.send_login_3pid_mail,
            next_link,
        )
...
class EmailLogin3pidSubmitTokenRestServlet(RestServlet):
    PATTERNS = client_patterns(
        "/login_3pid/email/submitToken$", releases=(), unstable=True
    )
    ...
    async def on_POST(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        ...
        try:
            ...
            raise SynapseError(e.code, str(e))
...
def register_servlets(hs: "HomeServer", http_server: HttpServer) -> None:
    ...
    EmailLogin3pidSubmitTokenRestServlet(hs).register(http_server)
